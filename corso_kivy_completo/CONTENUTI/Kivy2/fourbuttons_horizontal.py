...
class MyApp(App):
	...
	def build(self):
		...
		led_1 = ToggleButton(text="LED 1")
		led_1.bind(on_press=press_callback)
		led_2 = ToggleButton(text="LED 2")
		led_2.bind(on_press=press_callback)
		led_3 = ToggleButton(text="LED 3")
		led_3.bind(on_press=press_callback)
		led_4 = ToggleButton(text="LED 4")
		led_4.bind(on_press=press_callback)
